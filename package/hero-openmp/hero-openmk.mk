...
HERO_OPENMP_HERO_LIBPULP_DIR = $(BR2_EXTERNAL_HERO_PATH)/support/libpulp/inc
HERO_OPENMP_HERO_PULP_SHARED_DIR  = $(BR2_EXTERNAL_HERO_PATH)/support/include
# Enable debugging in libomptarget
HERO_OPENMP_CONF_OPTS = -DCMAKE_BUILD_TYPE=Debug -DLIBOMPTARGET_LLVM_INCLUDE_DIRS=$(BR2_EXTERNAL_HERO_PATH)/install/include/llvm
HERO_OPENMP_CONF_OPTS += -DLIBOMPTARGET_ENABLE_DEBUG=True
HERO_OPENMP_CONF_ENV  = LIBGOMP_PLUGIN_PULP_HERO_CPPFLAGS="-DPLATFORM=$(BR2_PACKAGE_HERO_PLATFORM)" HERO_PULP_INC_DIR=${HERO_OPENMP_PULP_INC_DIR} HERO_DEV_INC_DIR+=${HERO_OPENMP_PULP_INC_DIR} HERO_LIBPULP_DIR+=${HERO_OPENMP_HERO_LIBPULP_DIR} HERO_PULP_SHARED_DIR+=${HERO_OPENMP_HERO_PULP_SHARED_DIR}
